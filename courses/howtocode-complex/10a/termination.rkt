...
; reach the base case:
; 
; As long as the cutoff is > 0 and s starts at >= 0, repeated diviosn by 2 will eventually
; be less than cutoff
; 
; 
...
; reach the base case:
; 
; As long as the cutoff is > 0 and s starts at >= 0, repeated divison by 3 will eventually
; be less than cutoff
;      
;      
