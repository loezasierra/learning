...
;; produce a solution for board; or false of board is unsolvable
...
;; Board -> (listof Board)
;; return list of valid next boards from board
;; finds first empty square, fills it with Natural[1, 9], keeps only valid boards
(check-expect (next-boards BD1) (list (list 1 B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B)
                                      (list 2 B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B)
                                      (list 3 B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B)
                                      (list 4 B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B)
                                      (list 5 B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B)
                                      (list 6 B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B)
                                      (list 7 B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B)
                                      (list 8 B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B)
                                      (list 9 B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B B)
                                      ))
(check-expect (next-boards BD5) (list (list 5 2 B B B 4 B 7 B B 1 B B 5 B 6 B B B B 4 9 B B B B B B 9 B B B 7 5 B B 1 8 B 2 B B B B B B B B B B 6 B B B B B 3 B B B B B 8 B 6 B B 8 B B B 9 B B 8 B 7 B B 3 1)
                                      (list 5 3 B B B 4 B 7 B B 1 B B 5 B 6 B B B B 4 9 B B B B B B 9 B B B 7 5 B B 1 8 B 2 B B B B B B B B B B 6 B B B B B 3 B B B B B 8 B 6 B B 8 B B B 9 B B 8 B 7 B B 3 1)
                                      ))

(define (next-boards bd)
  (prune-boards (fill-boards (next-empty bd) bd)))


;; Board -> Pos
;; return position of first empty square
;; ASSUME: board is not full
(check-expect (next-empty BD1) 0)
(check-expect (next-empty BD2) 9)
(check-expect (next-empty BD3) 1)

(define (next-empty bd)
  (cond [(empty? bd) (error "The board didn't have a blank space.")]
        [else
         (if (false? (first bd))
             0
             (+ 1 (next-empty (rest bd))))
         ]))


;; Pos Board -> (listof Board)
;; produce 9 boards, with position filled with Natural[1 9]
(check-expect (fill-boards 0 BD1)
...
;; return list containing only valid boards
(check-expect (prune-boards (list (cons 1 (cons 1 (rest (rest BD1))))))
              empty)

(define (prune-boards lobd)
  (filter valid-board? lobd))


;; Board -> Bool
;; return true if no unit on the board has the same value twice; false otherwise
...
(define (valid-board? bd)
  (local [(define (valid-units? u)
            (cond [(empty? u) true]
                  [else
                   (local [(define (vals u) (filter integer? (map (λ (p) (read-square bd p)) u)))
                           (define try (valid-unit? (vals (first u))))]
                     (if (false? try)
                         false
                         (valid-units? (rest u))))]))
          
          (define (valid-unit? u)
            (local [(define (valid-num n)
                      (not (= (length (filter (λ (i) (= i n)) u)) 2)))]
              (andmap valid-num u)))]
    (valid-units? UNITS)))
...
(define (valid-board? bd)
  (local [(define (valid-units? lou)
          ...
          (define (valid-unit? u)
            (no-duplicates? (no-falses (read-unit u))))

          (define (read-unit u)
            (local [(define (read-pos p) (read-square bd p))]
              (map read-pos u)))

          (define (no-falses lovf)
            (filter integer? lovf))
